...
export default function Button({
  ...
  return (
    <button
      ...
      className={`relative flex items-center justify-center gap-2 rounded-sm font-medium ${variantStyles[variant]} ${sizeStyles[size]} ${bounceClass} ${className}`}
    >
      {/* Spinner overlay */}
      {isLoading && (
